<template>
  <div class="home">
    <div class="about">
      <p class="badges">
        <a href="https://discord.gg/HqmPjZn">
          <img
            src="https://discordapp.com/api/guilds/607929827760275456/widget.png?style=shield"
            style="height: 20px;"
          />
        </a>
      ...
      <p>
        <strong>Salmon Stats</strong> is an
        <a href="https://github.com/yukidaruma/salmon-stats-api">open-source</a> Splatoon 2 Salmon Run statistics
        website.
      </p>
      <p>
        To upload results to this website, please use
        <a href="https://github.com/tkgstrator/Salmonia/releases">command-line result uploader (Salmonia)</a>.
      </p>
      <p>
    ...
    <div v-if="isSchedulesAvailable" class="columns">
      <div class="column">
        <h2 class="has-margin-top">
          Last Schedule
        </h2>
        <schedule-card v-if="pastSchedules.length > 0" :schedule="pastSchedules[0]" />
      </div>
      ...
      <div class="column">
        ...
        <p v-if="!ongoingSchedule">
          There's no ongoing Salmon Run schedule.
        </p>
        <schedule-card v-else difference-to="endAt" :now="now" :schedule="ongoingSchedule" />
      </div>
